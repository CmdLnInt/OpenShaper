...
function AppShell() {
  ...
  // for what it is actually showing. `applyViewChange` returns the same object when
  // nothing moves, so the first render does not re-persist what it just restored.
  useEffect(() => {
    setSidebar((s) => applyViewChange(s, view));
  }, [view]);
